...
//- Context nesnesi olusturduk
//- Baslangic degeri verdik ve export ettik
//- Kullanmak istedigimiz component`a import ettik
//-Context type yardimiyla contexti ilgili component`a atadaik(static contextType = BookContext)
//-this.context yardimiyla ilgili veriye ulastik

// 2-) Provider ----------->Consumer

//-Class component olusturduk ve veriyi state icine yerlestirdik
//-Contexte ait Provider ile state`te bulunan veriyi aldik
//-Parent-Child iliskisi {this.props.children}
//-Veriyi gönderecegimiz component`à Context import ediyoruz
//-Render icerisinde Consumer ile Provider dan gelene veriyi yakaliyoruz
